...
export const getTopProductsController = async (req, res) => {
    try {
      // Find top products, sort by rating in descending order, and limit to 3
      ...
      // Handle errors
      console.error("Error in fetching top products:", error);
      res.status(500).json({
        success: false,
        message: "Error in fetching top products",
        error: error.message, // Only sending the error message for security
      });
    }
};
